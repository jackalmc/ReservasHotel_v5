...
public class ControladorHabBuscarReservas {
    ...
    private Habitacion habitacionABuscar = null;

    public void prepararHab(Habitacion habitacion) {
        if (habitacion != null){
            habitacionABuscar=habitacion;
            colReservas = VistaGrafica.getInstancia().getControlador().getReservas(habitacionABuscar);
